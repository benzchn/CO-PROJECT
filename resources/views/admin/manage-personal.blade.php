                        ...
                        <tbody>
                            @foreach ($personal as $list)
                               <tr>
                                <td>{{ $list->user_id }}</td>
                                <td>{{ $list->name }}</td>
                                <td><h5><label class='label label-info'>บุคลากร</label></h5></td>
                                <td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-warning" data-id="{{ $list->id }}"
                                        ...
                                        data-name="{{ $list->name }}"
                                        data-phone="{{ $list->phone }}" data-toggle="modal"
                                        data-target="#editUserModal"> <i class="glyphicon glyphicon-edit"></i>
                                        แก้ไข</button>
...
<div class="modal fade" id="editUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="editTeachForm" action="{{ route('manage-personal.update',$list->id) }}" method="POST">
                @csrf
                {{ method_field('patch') }}
                ...
                <div class="modal-body">
                    ...
                    <div class="edit-Teach-result">
                        <div style="padding:30px;">
                            ...
                            <div class="form-group">
                                <label for="phone">เบอร์โทรศัพท์ *</label>&nbsp;<span class="label label-info"
                                    style="font-weight:normal;">(ไม่ต้องใส่ขีด)</span>
                                <input type="text" class="form-control" id="phone" name="phone"
                                    placeholder="Phone" autocomplete="off" required OnKeyPress="return chkNumber(this)">
                            </div>
                        </div>
                    </div>
                    <!-- /edit brand result -->
                ...
                <div class="modal-footer editTeachFooter">
                    ...
                    <button type="submit" class="btn btn-success" id="editTeachBtn" name="editTeachBtn"
